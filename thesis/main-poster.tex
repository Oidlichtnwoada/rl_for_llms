...
\author{Dipl.-Ing.\ Hannes Brantner}
...
\settitle{
	\begin{minipage}[c]{0.82\linewidth}
		...
		{\color{titlefgcolor}\large \textbf{\@author} (K1614466) \quad\textbar\quad
			Supervisor: \textbf{Univ.-Prof.\ Dr.\ Sepp Hochreiter} \quad\textbar\quad
			Assistant Supervisors: Dr.\ Johannes Schimunek, Dipl.-Ing.\ Christoph Bartmann \quad\textbar\quad
			\@institute\par}
	\end{minipage}\hfill
...
\block{}{%
	...
	\centering
	\statbox{$\AccBeforePct{\AnsBase}{pass@1}{0} \rightarrow \AccAfterPct{\AnsDenseSR}{pass@1}{0}$}{\textit{Pass}@1 (\textit{Base} $\to$ \textit{Dense})}\hfill
...
\begin{columns}
	...
	\block{Training-time architecture}{%
		\begin{center}
			\resizebox{0.72\linewidth}{!}{\input{architecture_tikz.tex}}
		\end{center}
		\vspace{4pt}
